      ...
      <AnimatePresence>
        {!isMobile && isSidePanelOpen && (
          <motion.div
            ...
            className="w-full md:w-1/3 h-[50svh] md:h-full bg-gray-800 backdrop-blur-md shadow-lg p-4 relative z-10 flex flex-col"
          >
      ...
      {!isMobile && !isSidePanelOpen && (
        <>
          ...
          <motion.button
            ...
            className="absolute right-1 top-1/2 -translate-y-1/2 bg-gray-800 text-white p-2 rounded-l-lg shadow-lg cursor-pointer z-[20]"
            initial={{ scale: 1, x: 0 }}
